...
var SampleValidator = (function () {
    ...
    function validateCheckout() {
        ...
        //address
        address = document.getElementById("deliveryAddress1").value;
        ...
        if (messages.length === 0) {
            ...
            document.getElementById("cartDisplay").innerText = "Your cart is currently empty.";
            document.getElementById("cartError").style.display = "none";
            document.getElementById("purchaseSuccess").innerText = "Success! Thank you for your purchase :)";
